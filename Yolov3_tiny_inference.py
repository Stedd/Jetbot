...
from Yolov3_tiny_data_processing_v2 import PreprocessYOLO, PostprocessYOLO, ALL_CATEGORIES
...
class Yolov3Inference():
    def __init__(self, onnx_name):
        ...
        # Make sure to change data_processing.py --> label txt file name, and number of classes
        # In this case, assert 2

        # Try to load a previously generated YOLOv3-608 network graph in ONNX format:
        self.onnx_file_path = './' + onnx_name
        self.engine_file_path = "yolov3-tiny.trt"

        # Two-dimensional tuple with the target network's (spatial) input resolution in HW ordered
        # From darknet detector output
        ...
        self.output_shapes = [(1, 21, 13, 13), (1, 21, 26, 26)]
        ...
        # Set post-processing args
        self.postprocessor_args = {"yolo_masks": [(3, 4, 5), (0, 1, 2)],                    # A list of 3 three-dimensional tuples for the YOLO masks
        ...
        # output_image_path = 'berries_bboxes.png'
    ...
    def detectBerry(self, input_image):
        # Load an image from the specified input path, and return it together with  a pre-processed version
        self.resized_image = self.preprocessor.process(input_image)
        
        # Store the shape of the original input image in WH format, we will need it for later
        shape_orig_WH = input_image.shape

        # Set host input to the image. The common.do_inference function will copy the input to the GPU before executing.
        self.inputs[0].host = self.resized_image
