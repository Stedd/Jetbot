...
LABEL_FILE_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)),'calibration_files/berries_labels.txt')
...
class PreprocessYOLO(object):
    ...
    def process(self, input_image):
        ...
        Keyword arguments:
        input_image -- numpy image H x W x 3
        """
        image_resized = self._resize(input_image)
...
class PostprocessYOLO(object):
    ...
    def _process_yolo_output(self, outputs_reshaped, resolution_raw):
        ...
        height, width, _ = resolution_raw # _ is channels (3)
